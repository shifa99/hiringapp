...
import 'package:hiring_app/modules/Employee/chat_employee_screen.dart';
              ...
              child: isGuest
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) => InkWell(
                        onTap: () 
                        {
                          print('object ${users.userChatsModel.employees[index].id}');
                          navigateTo(
                              context,
                              ChatEmployeeScreen(users.userChatsModel.employees[index].id)
                                  );
                        },
                        child: Card(
                              ...
                              children: [
                                CircleAvatar(
                                  ...
                                  backgroundImage: NetworkImage(users
                                      .userChatsModel.employees[index].image),
                                ),
                                SizedBox(width: 10),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(users.userChatsModel.employees[index]
                                        .fullName),
                                    Text('Cairo, Egypt'),
                                  ],
                                ),
