class MeetingSummeryModel {
  bool status;
  String message;
  List<Schedule> schedule=[];

  MeetingSummeryModel({this.status, this.message, this.schedule});
  MeetingSummeryModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Schedule {
  ...
  Schedule.fromJson(Map<String, dynamic> json) {
    ...
    jobField = json['job_field'] != null
        ?  JobField.fromJson(json['job_field'])
        : null;
